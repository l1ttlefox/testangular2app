...
export class FormComponent implements OnInit {
  ...
  onChange = (e): void => {
    ...
    alert('Cannot be set to true ,' +
      ' without an  Account Deletion Confirmation  email template having been defined' +
      ' either in the accountDeletedEmailTemplates parameter or in the RaaS Email Templates.');
  };
